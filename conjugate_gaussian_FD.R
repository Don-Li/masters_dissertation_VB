...
deriv_posterior = function( N, xbar, sigma2,
    a0, b0, mu0, lambda0, r_mu, r_tau){
    ...
    list(
        d_mu_lik = deriv_p_mu_lik, d_mu_prior = deriv_p_mu_prior,
        d_tau_lik = deriv_p_tau_lik, d_tau_prior = deriv_p_tau_prior
    )
}
...
FD_CAVI_conjugate_guassian = function( x, a0, b0, mu0, lambda0, r_mu, r_tau, p_seq ){
    ...
    deriv_prior = deriv_posterior( N, xbar, sigma2,
        a0, b0, mu0, lambda0, r_mu, r_tau )
    deriv_p_mu_lik = deriv_prior$d_mu_lik
    deriv_p_mu_prior = deriv_prior$d_mu_prior
    deriv_p_tau_lik = deriv_prior$d_tau_lik
    deriv_p_tau_prior = deriv_prior$d_tau_prior
